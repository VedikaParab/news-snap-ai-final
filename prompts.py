...
Ensure your analysis is objective, balanced, and uses clear language suitable for a general audience.
...
Your response should be clear, concise, and engaging, suitable for a conversational context.
